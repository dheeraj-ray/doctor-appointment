...
import { Menu, X, ChevronDown, Bell, LogOut, User, Users, Stethoscope, Calendar, CreditCard, Settings, BarChart3, ShieldCheck, MessageSquare, Home } from 'lucide-react';
...
const adminSidebarItems = [
  ...
  { label: 'Specializations', href: '/admin/specializations', icon: <ShieldCheck className="h-5 w-5" /> },
  { label: 'Payments', href: '/admin/payments', icon: <CreditCard className="h-5 w-5" /> },
  { label: 'Reviews', href: '/admin/reviews', icon: <MessageSquare className="h-5 w-5" /> },
  { label: 'Settings', href: '/admin/settings', icon: <Settings className="h-5 w-5" /> },
];

const adminMobileNavItems = [
  { label: 'Dashboard', href: '/admin', icon: <BarChart3 className="h-5 w-5" /> },
  { label: 'Users', href: '/admin/doctors', icon: <Users className="h-5 w-5" /> },
  { label: 'Appointments', href: '/admin/appointments', icon: <Calendar className="h-5 w-5" /> },
  { label: 'Reports', href: '/admin/reports', icon: <BarChart3 className="h-5 w-5" /> },
  { label: 'More', href: '/admin/settings', icon: <Settings className="h-5 w-5" /> },
];
    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto" role="navigation" aria-label="Admin menu">
